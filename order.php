...
?>
   ...
   // $productsx_prices = array($_SESSION['product_price']);?>
            ...
            <td><?php echo $rows['product_name']; $mem_username=$rows['mem_username'];?>
            <?php echo $rows['product_name']; $mem_address=$rows['mem_address'];?></td>
    ...
    <table class="table table-bordered">
        <tr>
            <td colspan="5" style="padding-bottom: 4px;padding-top: 4px;">
                <div style="font-size:18px; margin-left:685px"><?php echo $totalprice?>：<?php echo number_format($rowsum['summy'],2); echo " ".$baht?></div> 
            </td>
        </tr>
        <tr>
            <td colspan="5" style="padding-bottom: 4px;padding-top: 4px;">
                <div style="font-size:18px;margin-left:633px"><?php echo $discountall?> ：0.00 <?php echo $baht?></div>
            </td>
        </tr>
        <tr>
            <td colspan="5" style="padding-bottom: 4px;padding-top: 4px;">
                <div style="font-size:18px;margin-left:460px;color:green"><?php echo $allprice?>: <a style="color:red"><?php echo $notshipping?></a> <?php echo number_format($rowsum['summy'],2); echo " ".$baht?></div>
            </td>
        </tr>
    </table>
    <br>
            ...
            <label class="$mem_username"><h5><?php echo $lusername?></h5></label>
              <div class="input-group-text"></div>
                <textarea name="$mem_username" rows="1" class="form-control"><?php echo $mem_username?></textarea>
              </div>
              <br><br>
