...
<body>
    ...
    <div class="container card-5">
        <br><h3><center><?php echo $about ?></center></h3><br>
        <div class="row">
  <br><div class="col-6 col-md-4 border border-secondary rounded card-3"><br><center><h5><?php echo$Contact ?></h5><?php echo $faddress."<br>".$femail."<br>". $ftel ?></center></div><br>
  <div class="col-6 col-md-4 border border-secondary rounded card-3"><br><center><h5><?php echo$history ?></h5></center><?php echo$historys ?></div><br>
  <div class="col-6 col-md-4 border border-secondary rounded card-3"><br><center><h5><?php echo$Service ?></h5><?php echo $Support24hr."<br>".$CashonDelivery ?></center></div><br>
  <div class="col-12 "><br><h5><center><?php echo $map?></center></h5><img style="width:1100px"src="assets/image/map.png "></div><br>
