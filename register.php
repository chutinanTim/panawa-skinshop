      ...
      <div class="modal-content">
        ...
        <form class="form col-12" id="formRegister" method="post" action="php/register_process.php">
              ...
              <!--<div class="form-group mb-2 mr-sm-2">-->
                   <!--<center> --> 
                    <!-- localhost-》6Lc49b0hAAAAAASwZ8AOyFY_LvLPnDQ-5dg1Al7a -->
                    <!-- worawin。tk -》6Lc49b0hAAAAAPXfbJxzBWdQONcrLR59NFigk_jL -->
                      <!--<div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6Lc49b0hAAAAAASwZ8AOyFY_LvLPnDQ-5dg1Al7a"></--><!--div>-->
                  <!--</center>-->
              <!--</div>-->
