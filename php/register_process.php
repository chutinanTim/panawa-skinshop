<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($_POST['submit'])){ 
                // local->6LcF6b0hAAAAAIAUpDAlfts1iaPiqS0WjeZsyyN0
                // domain->6LcF6b0hAAAAAN5tnHyjybN2RhZSpRf2FkkBbC5N

                // local->6Lc49b0hAAAAAASwZ8AOyFY_LvLPnDQ-5dg1Al7a
                // domain->6Lc49b0hAAAAAPXfbJxzBWdQONcrLR59NFigk_jL
                //$secretKey = "6Lc49b0hAAAAAPXfbJxzBWdQONcrLR59NFigk_jL";
