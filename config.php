...
if($lang == 'th')
{
    ...
    $Support24hr = "ดูแลตลอด 24 ชั่วโมง";
    $CashonDelivery = "เก็บเงินปลายทาง";
    $Contact = "ติดต่อ";
    $faddress = "บางกะปิ กรุงเทพฯ 10240";
    $femail = "Skinshop@example.com";
    $ftel = "+66 623847669";
    ...
    $e80= " Ems / 80 ต่อชิ้น";
    $historys="เว็บไซต์นี้สร้างขึ้นมาเพื่อเพิ่มความสะดวกสบายในการซื้อสกินแคร์ ";
    $map="แผนที่";
...
else if($lang == 'en')
{
    ...
    $Contact = "Contact";
    $faddress = "Bangkapi. Bangkok 10240";
    $femail = "Skinshop@example.com";
    $ftel = "+66 623847669";
    $lusername = "Username";
    $lpassword = "Password"; 
    ...
    $historys="This website was created to make shopping for skin care more convenient.";
    $map="Map";
    $profile="Profile";
    $user="Username";
    $name="Name";
